...
<table style="width: 600px;text-align: center;" height="450px" cellpadding="10" cellpadding="5" >
	...
	<tr>
		<td colspan="4" style="text-align:center;"> <input type="submit" name="ok" value="ENREGISTRER" class="btn btn-outline-dark" style="width: 200px;text-align:center;"  required><br><br><a href="login.php" style="margin: 100;">login?</a> </td>
	</tr></div>
	</form>
